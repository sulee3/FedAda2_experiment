...
class Femnist_data():
    def __init__(self, NUM_CLIENTS, IID, BATCH_SIZE, data_dir='/home/sulee/leaf/data/femnist/data/all_data/'):
        ...
        # Adjusted normalization parameters for grayscale images
        self.transform = transforms.Compose([
            transforms.Resize((224, 224)),  # Resize to 224x224
            transforms.Grayscale(num_output_channels=3),  # Convert to 3 channels
            transforms.ToTensor(),  # Convert PIL Image to Tensor
            transforms.Normalize(mean=[0.5, 0.5, 0.5],  # Adjusted mean
    ...
    class TransformedCustomDataset(Dataset):
        ...
        def __getitem__(self, idx):
            ...
            # Check the image range and scale appropriately
            if image.max() <= 1.0:
